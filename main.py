...
def run_reproject(pixels, R_wc, t_wc, K, image, obj_meshes=None, shift=None):
    ...
    # print(f"t_wc: {t_wc}")
    # print(f"K: {K}")
    # print(f"Object meshes: {obj_meshes}")
    # print(f"Shift: {shift}")
...
if __name__ == "__main__":
    ...
    drill_mesh = trimesh.load("/Users/saikoushik/Downloads/HW2/hw2_student_code/data/models/drill.obj")
    fuze_mesh = trimesh.load("/Users/saikoushik/Downloads/HW2/hw2_student_code/data/models/fuze.obj")
    ...
    print('Complete.')
    print('Saving GIF ...')
    print(f"Final array shape: {final.shape}")
